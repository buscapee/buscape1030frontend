...
const FormSale = ({ requerimentSelected }) => {
    ...
    const { createRequerimentSale, editRequerimentData } = useContext(RequirementsContext)
    ...
    return (
        <div className="flex flex-col items-center w-full">
            <form onSubmit={isEditing ? handleSaveEdit : handleSubmit} className="bg-white rounded shadow border border-gray-200 w-full max-w-3xl mx-auto flex flex-col gap-6 mt-6" style={{padding: 0}}>
                <div className="rounded-t bg-[#14532d] px-6 py-3 text-white font-bold text-lg border-b border-green-900">Efetuar Venda de Cargo</div>
                <div className="flex flex-col gap-4 px-6 py-6">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <input type="text"
                            ...
                            required
                            placeholder="Digite o nick do militar que está comprando o cargo"
                        />
                    </div>
                    <div className="flex flex-col gap-2">
                        <label className="font-semibold">Cargo Comprado:</label>
                    ...
                    <div className="flex flex-col gap-2">
                        <label className="font-semibold">Valor Recebido:</label>
                        <input type="number"
                            className="border rounded px-3 py-2 bg-white"
                            onChange={(e) => {
                            ...
                            required
                            placeholder="Digite o valor em dinheiro ou em reais que o comprador pagou"
                        />
                    </div>
                    <div className="flex flex-col gap-2">
            ...
            <ConfirmationModal
                open={showConfirm}
                title="Confirmação"
                message={`Tem certeza que deseja excluir o requerimento de venda de cargo para \"${promoted}\"? Essa ação não poderá ser desfeita.`}
