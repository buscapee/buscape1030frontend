...
const FormContract = ({ requerimentSelected }) => {
    ...
    const { createRequerimentContract, editRequerimentData } = useContext(RequirementsContext)
    ...
    return (
        <div className="flex flex-col items-center w-full">
            <form onSubmit={isEditing ? handleSaveEdit : handleSubmit} className="bg-white rounded shadow border border-gray-200 w-full max-w-3xl mx-auto flex flex-col gap-6 mt-6" style={{padding: 0}}>
                <div className="rounded-t bg-[#14532d] px-6 py-3 text-white font-bold text-lg border-b border-green-900">Efetuar Contratação</div>
                <div className="flex flex-col gap-4 px-6 py-6">
                    ...
                    <div className="flex flex-col gap-2">
                        <label className="font-semibold">Contratado:</label>
                        <input type="text"
                            ...
                            placeholder="Digite o nick do militar que será contratado"
                        />
                    </div>
                    <div className="flex flex-col gap-2">
                        <label className="font-semibold">Patente:</label>
                        <select onChange={(e) => setPatent(e.target.value)} disabled={requerimentSelected && !isEditing} className="border rounded px-3 py-2 bg-white">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <textarea
                            ...
                            value={reason}
                            placeholder="Digite o motivo da contratação"
            ...
            <ConfirmationModal
                open={showConfirm}
                title="Confirmação"
                message={`Tem certeza que deseja excluir o requerimento de contratação para \"${promoted}\"? Essa ação não poderá ser desfeita.`}
